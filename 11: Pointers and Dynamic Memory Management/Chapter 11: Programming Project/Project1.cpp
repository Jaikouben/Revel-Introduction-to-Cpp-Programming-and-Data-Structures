...
A bounding rectangle is the minimum rectangle that endoses a set of points in a two-dimensional plane, as shown in Figure 11.9d.
...
Use the code from https://liangcpp.pearsoncmg.com/test/Exercise11_11.txt to complete your program.
